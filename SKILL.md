...
version: 1.0.0
author: Galaxy Maps
repository: https://github.com/Galaxy-Maps/gm-agent-01-orchestrator
triggers:
  - "create a galaxy map"
  - "build a curriculum"
...
|------:|----------------|
| 1 | [`gm-agent-02-intent`](https://github.com/Galaxy-Maps/gm-agent-02-intent) |
| 2 | [`gm-agent-03-curriculum`](https://github.com/Galaxy-Maps/gm-agent-03-curriculum) |
...
For the Agent Teams variant of this stack, install the `gm-agent-0Na-*-with-agent-teams` companion repos instead and use [`gm-agent-01a-orchestrator-with-agent-teams`](https://github.com/Galaxy-Maps/gm-agent-01a-orchestrator-with-agent-teams).
